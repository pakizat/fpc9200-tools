...
ipcMain.handle('capture-samples', async (_event, sampleType) => {
    try {
...
ipcMain.handle('get-report', async (_event, reportId) => {
    try {
...
ipcMain.handle('delete-sample', async (_event, sampleType, sampleId) => {
    try {
